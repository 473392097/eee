...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010302','0103','课程类别','${pageContext.request.contextPath}/second_findAll.action','','right');
		d.add('0104','01','就业部');
		...
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/first_findAll.action','','right');
